#take input from user and save them in afile when user click save changes . and add new line when click on add line and save and close file when click on save and close
from tkinter import *
